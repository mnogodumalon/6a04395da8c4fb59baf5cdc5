...
const PROXY_BASE = '';
const APP_ID = '6a04393b87d551873784e867';
...
export default function PublicFormAbwesenheiten() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Abwesenheiten — Formular</h1>
        </div>
