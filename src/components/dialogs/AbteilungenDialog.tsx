...
interface AbteilungenDialogProps {
  ...
  defaultValues?: Abteilungen['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function AbteilungenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: AbteilungenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'abteilungen');
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "abteilung_name": string | null, // Abteilungsname\n  "abteilung_kuerzel": string | null, // Kürzel\n  "abteilung_beschreibung": string | null, // Beschreibung\n  "abteilung_leiter_vorname": string | null, // Abteilungsleiter Vorname\n  "abteilung_leiter_nachname": string | null, // Abteilungsleiter Nachname\n  "abteilung_standort": string | null, // Standort\n  "abteilung_telefon": string | null, // Telefon\n}`;
  ...
  const DIALOG_INTENT = defaultValues ? 'Abteilungen bearbeiten' : 'Abteilungen hinzufügen';
